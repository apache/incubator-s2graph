...
object S2GraphFactory {
  ...
  def initDefaultSchema(graph: S2Graph): Unit = {
    ...
    val DefaultColumnMetas = {
      ...
      ColumnMeta.findOrInsert(DefaultColumn.id.get, "age", "integer", storeInGlobalIndex = true, useCache = false)
      ColumnMeta.findOrInsert(DefaultColumn.id.get, "lang", "string", storeInGlobalIndex = true, useCache = false)
      ColumnMeta.findOrInsert(DefaultColumn.id.get, "oid", "integer", storeInGlobalIndex = true, useCache = false)
      ColumnMeta.findOrInsert(DefaultColumn.id.get, "communityIndex", "integer", storeInGlobalIndex = true, useCache = false)
      ...
      ColumnMeta.findOrInsert(DefaultColumn.id.get, "boolean", "boolean", storeInGlobalIndex = true, useCache = false)
      ColumnMeta.findOrInsert(DefaultColumn.id.get, "long", "long", storeInGlobalIndex = true, useCache = false)
      ColumnMeta.findOrInsert(DefaultColumn.id.get, "float", "float", storeInGlobalIndex = true, useCache = false)
      ColumnMeta.findOrInsert(DefaultColumn.id.get, "double", "double", storeInGlobalIndex = true, useCache = false)
      ColumnMeta.findOrInsert(DefaultColumn.id.get, "integer", "integer", storeInGlobalIndex = true, useCache = false)
      ColumnMeta.findOrInsert(DefaultColumn.id.get, "aKey", "string", storeInGlobalIndex = true, useCache = false)
      ColumnMeta.findOrInsert(DefaultColumn.id.get, "x", "integer", storeInGlobalIndex = true, useCache = false)
      ColumnMeta.findOrInsert(DefaultColumn.id.get, "y", "integer", storeInGlobalIndex = true, useCache = false)
      ...
      ColumnMeta.findOrInsert(DefaultColumn.id.get, "myId", "integer", storeInGlobalIndex = true, useCache = false)
