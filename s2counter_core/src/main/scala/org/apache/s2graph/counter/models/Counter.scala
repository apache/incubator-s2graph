...
case class Counter(id: Int,
                   ...
                   dimension: String,
                   useProfile: Boolean,
                   bucketImpId: Option[String],
                   useRank: Boolean,
                   ttl: Int,
                   dailyTtl: Option[Int],
                   hbaseTable: Option[String],
                   intervalUnit: Option[String],
                   rateActionId: Option[Int],
                   rateBaseId: Option[Int],
                   rateThreshold: Option[Int]) {
  val intervals: Array[String] =
    intervalUnit.map(s => s.split(',')).getOrElse(Array("t", "M", "d", "H"))
...
object Counter extends SQLSyntaxSupport[Counter] {
  ...
  def apply(useFlag: Boolean,
            ...
            ttl: Int = 259200,
            dailyTtl: Option[Int] = None,
            hbaseTable: Option[String] = None,
            intervalUnit: Option[String] = None,
            rateActionId: Option[Int] = None,
...
class CounterModel(config: Config) extends CachedDBModel[Counter] {
  ...
  def findByServiceAction(service: String,
                          action: String,
