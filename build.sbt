...
lazy val s2rest_netty = project.dependsOn(s2core).settings(commonSettings: _*)
...
lazy val s2counter_core =
  project.dependsOn(s2core).settings(commonSettings: _*)
